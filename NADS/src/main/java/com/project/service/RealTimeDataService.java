...
public class RealTimeDataService {
    ...
    public RealTimeDataService(ElasticService elasticService, DataWebSocketHandler webSocketHandler) {
    ...
    public void fetchDataAndSend() {
        ...
        String jsonData = elasticService.convertToJson(data);  // JSON 변환
        try {
            webSocketHandler.sendMessage(jsonData);  // WebSocket으로 전송
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
